...
ScrollReveal().reveal(
  ".home-img, .services-container, .protofolio-box, .contact form, .skills,.subtitle, .about-content,.about-btn, .education-row, .portfolio-container",
  { origin: "bottom" }
);
ScrollReveal().reveal(
  " .contact form,.home-content h1, .education-row, .skills-row",
  { origin: "left" }
);
...
const typed = new Typed(".multiple-text", {
  strings: ["Frontend Developer", "Ui UX Designer", "Wordpress Developer"],
  typeSpeed: 100,
  backDelay: 700,
  loop: true,
});
